...
jQuery(document).ready(function () {
    ...
    $(document).on('click', '#chooseIview', function (e) {
        e.preventDefault();
        swal({
            title: "Do you want to proceed with the selected applicant?",
            //text: "You won't be able to revert this!",
            type: "warning",
            showCancelButton: !0,
            confirmButtonText: "Yes"
    ...
    // click resubmit    
    $(document).on('click', '#advResubmit', function (e) {
        e.preventDefault();
        var actVal = $("#resubmitVal").val();
        var act='';
        actVal == 0 ? act='cancel' : actVal == 1 ? act='resubmit' : act='close';
        swal({
            title: "Are you sure to "+act+" this advertisement?",
            //text: "You won't be able to revert this!",
            type: "warning",
            showCancelButton: !0,
            confirmButtonText: "Yes"
    ...
    // click approve/decline/reject    
    $(document).on('click', '#btnApprRevDec', function (e) {
        e.preventDefault();
        var actVal = $("#advApproveVal").val();
        var act=''; 
        switch(actVal){
            case '1': act='approve';break;
            case '2': act='reject';break;
            case '3': act='revert';break;
            default: act='unknown'; break;
        }
        swal({
            title: "Are you sure to "+act+" this advertisement request?",
            //text: "You won't be able to revert this!",
            type: "warning",
            showCancelButton: !0,
            confirmButtonText: "Yes"
