...
jQuery(document).ready(function () {
    ...
    $(document).on('click', '#delfaqextra', function (e) {
        e.preventDefault();
        swal({
...
jQuery(document).ready(function () {
	//confirmApplicant.init();	
    $(document).on('click', '#delfaqweb', function (e) {
        e.preventDefault();
        swal({
            title: "Are you sure to delete?",
            //text: "You won't be able to revert this!",
...
jQuery(document).ready(function () {
	//confirmApplicant.init();	
    $(document).on('click', '#delfaqapp', function (e) {
        e.preventDefault();
        swal({
            title: "Are you sure to delete?",
            type: "warning",
...
jQuery(document).ready(function () {
	//confirmApplicant.init();	
    $(document).on('click', '#delfaqjobads', function (e) {
        e.preventDefault();
        swal({
            title: "Are you sure to delete?",
            type: "warning",
    ...
    jQuery(document).ready(function () {
        //confirmApplicant.init();	
        $(document).on('click', '#delquesweb', function (e) {
            e.preventDefault();
            swal({
                title: "Are you sure to delete?",
                //text: "You won't be able to revert this!",
    ...
    jQuery(document).ready(function () {
        //confirmApplicant.init();	
        $(document).on('click', '#generateSet', function (e) {
            e.preventDefault();
            swal({
                title: "Any data on destination will be overwrite. Continue?",
                //text: "You won't be able to revert this!",
                type: "warning",
                showCancelButton: !0,
                confirmButtonText: "Yes"
