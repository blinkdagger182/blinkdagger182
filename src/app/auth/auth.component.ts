...
export class AuthComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        let isAdmin = "/admin/";
        this.returnUrl = isAdmin;
        //this.returnUrl = this._route.snapshot.queryParams['returnUrl'] || '/';
        this.returnUrl = this._route.snapshot.queryParams['returnUrl'] || isAdmin;
        ...
        let urlArr = (this._route.snapshot.queryParams['returnUrl']).split("/");
        if (urlArr[1].toLocaleUpperCase().trim() == 'ADMIN') {
            this.loginType = 'admin'; this.iamadmin = true;
        }
    }
    loginType = 'user';
    iamadmin = false;
    signin() {
        ...
        //  console.log(urlArr[1].toLocaleUpperCase().trim());
        if (urlArr[1].toLocaleUpperCase().trim() == 'ADMIN') {
            this.loginType = 'admin'; this.iamadmin = true;
        }
        this.loading = true;
