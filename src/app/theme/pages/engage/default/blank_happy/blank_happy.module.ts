...
import { EngageBlankHappyComponent } from './blank_happy.component';
...
const routes: Routes = [
    {
        ...
        'children': [
            {
                'path': '',
                'component': EngageBlankHappyComponent,
            },
        ],
    },
];
...
@NgModule({
    imports: [
        CommonModule, RouterModule.forChild(routes), LayoutModule, FormsModule, ReactiveFormsModule, SharedModule,
...
export class EngageBlankHappyModule {
}