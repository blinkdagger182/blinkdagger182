...
import { PTVars } from './ne-job-application-vars';
...
@Component({
    selector: 'app-ne-job-application',
    templateUrl: './ne-job-application.component.html',
    encapsulation: ViewEncapsulation.None,
    styleUrls: ['../dashboard-css.css']
})

export class NeJobApplicationComponent implements OnInit, AfterViewInit {
    ...
    ngAfterViewInit() {
        this._script.loadScripts('app-ne-job-application',
        [
