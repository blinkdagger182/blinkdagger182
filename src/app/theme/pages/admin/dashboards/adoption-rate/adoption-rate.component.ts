...
import { PTVars } from './adoption-rate-vars';
...
@Component({
    selector: 'app-adoption-rate',
    templateUrl: './adoption-rate.component.html',
    encapsulation: ViewEncapsulation.None,
    styleUrls: ['../dashboard-css.css']
})

export class AdoptionRateComponent implements OnInit, AfterViewInit {
    ...
    ngAfterViewInit() {
        this._script.loadScripts('app-adoption-rate',
        [
