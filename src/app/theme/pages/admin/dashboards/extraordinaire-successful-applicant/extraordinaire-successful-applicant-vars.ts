export const PTVars = Object.freeze({
    title1: 'Extraordinaire',
    title2: 'Extraordinaire Successful Applicant',
    ...
    reportFilter: '/report/project/tracking/filter',
    applyReportFilter: '/report/project/tracking',
