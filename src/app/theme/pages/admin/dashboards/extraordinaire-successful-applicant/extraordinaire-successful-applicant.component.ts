...
import { PTVars } from './extraordinaire-successful-applicant-vars';
...
@Component({
    selector: 'app-extraordinaire-successful-applicant',
    templateUrl: './extraordinaire-successful-applicant.component.html',
    encapsulation: ViewEncapsulation.None,
    styleUrls: ['../dashboard-css.css']
})

export class ExtraordinaireSuccessfulApplicantComponent implements OnInit, AfterViewInit {
    ...
    ngAfterViewInit() {
        this._script.loadScripts('app-extraordinaire-successful-applicant',
        [
