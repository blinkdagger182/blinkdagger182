...
import { PTVars } from './successful-applicant-vars';
...
@Component({
    selector: 'app-successful-applicant',
    templateUrl: './successful-applicant.component.html',
    encapsulation: ViewEncapsulation.None,
    styleUrls: ['../dashboard-css.css']
})

export class SuccessfulApplicantComponent implements OnInit, AfterViewInit {
    ...
    ngAfterViewInit() {
        this._script.loadScripts('app-successful-applicant',
        [
