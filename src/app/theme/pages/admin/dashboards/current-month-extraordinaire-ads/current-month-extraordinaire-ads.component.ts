...
import { PTVars } from './current-month-extraordinaire-ads-vars';
...
@Component({
    selector: 'app-current-month-extraordinaire-ads',
    templateUrl: './current-month-extraordinaire-ads.component.html',
    encapsulation: ViewEncapsulation.None,
    styleUrls: ['../dashboard-css.css']
})

export class CurrentMonthExtraordinaireAdsComponent implements OnInit, AfterViewInit {
    ...
    ngAfterViewInit() {
        this._script.loadScripts('app-current-month-extraordinaire-ads',
        [
