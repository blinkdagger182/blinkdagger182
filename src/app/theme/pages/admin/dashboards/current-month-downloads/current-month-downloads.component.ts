...
import { PTVars } from './current-month-downloads-vars';
...
@Component({
    selector: 'app-current-month-downloads',
    templateUrl: './current-month-downloads.component.html',
    encapsulation: ViewEncapsulation.None,
    styleUrls: ['../dashboard-css.css']
})

export class CurrentMonthDownloadsComponent implements OnInit, AfterViewInit {
    ...
    ngAfterViewInit() {
        this._script.loadScripts('app-current-month-downloads',
        [
