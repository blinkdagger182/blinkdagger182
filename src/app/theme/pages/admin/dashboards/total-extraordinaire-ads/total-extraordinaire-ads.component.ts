...
import { PTVars } from './total-extraordinaire-ads-vars';
...
@Component({
    selector: 'app-total-extraordinaire-ads',
    templateUrl: './total-extraordinaire-ads.component.html',
    encapsulation: ViewEncapsulation.None,
    styleUrls: ['../dashboard-css.css']
})

export class TotalExtraordinaireAdsComponent implements OnInit, AfterViewInit {
    ...
    ngAfterViewInit() {
        this._script.loadScripts('app-total-extraordinaire-ads',
        [
