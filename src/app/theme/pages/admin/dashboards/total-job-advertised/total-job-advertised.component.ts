...
import { PTVars } from './total-job-advertised-vars';
...
@Component({
    selector: 'app-total-job-advertised',
    templateUrl: './total-job-advertised.component.html',
    encapsulation: ViewEncapsulation.None,
    styleUrls: ['../dashboard-css.css']
})

export class TotalJobAdvertisedComponent implements OnInit, AfterViewInit {
    ...
    ngAfterViewInit() {
        this._script.loadScripts('app-total-job-advertised',
        [
        ...
        if ((myEd.setHours(0, 0, 0, 0) - mySt.setHours(0, 0, 0, 0)) / ONE_DAY < 0) {
            ...
            if(type === 0){
                ...
                dataPos = {
                    ...
                    day: this.filterForm.get('filterDay').value === 'All' || this.filterForm.get('filterDay').value === null ? '' : this.filterForm.get('filterDay').value,
