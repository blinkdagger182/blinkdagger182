...
import { PTVars } from './current-month-job-advertised-vars';
...
@Component({
    selector: 'app-current-month-job-advertised',
    templateUrl: './current-month-job-advertised.component.html',
    encapsulation: ViewEncapsulation.None,
    styleUrls: ['../dashboard-css.css']
})

export class CurrentMonthJobAdvertisedComponent implements OnInit, AfterViewInit {
    ...
    ngAfterViewInit() {
        this._script.loadScripts('app-current-month-job-advertised',
        [
