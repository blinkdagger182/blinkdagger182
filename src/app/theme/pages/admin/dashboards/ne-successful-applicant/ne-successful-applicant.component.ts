...
import { PTVars } from './ne-successful-applicant-vars';
...
@Component({
    selector: 'app-ne-successful-applicant',
    templateUrl: './ne-successful-applicant.component.html',
    encapsulation: ViewEncapsulation.None,
    styleUrls: ['../dashboard-css.css']
})

export class NeSuccessfulApplicantComponent implements OnInit, AfterViewInit {
    ...
    ngAfterViewInit() {
        this._script.loadScripts('app-ne-successful-applicant',
        [
