...
import { PTVars } from './total-downloads-vars';
...
@Component({
    selector: 'app-total-downloads',
    templateUrl: './total-downloads.component.html',
    encapsulation: ViewEncapsulation.None,
    styleUrls: ['../dashboard-css.css']
})

export class TotalDownloadsComponent implements OnInit, AfterViewInit {
    ...
    ngAfterViewInit() {
        this._script.loadScripts('app-total-downloads',
        [
