...
import { PTVars } from './current-month-ne-promotion-ads-vars';
...
@Component({
    selector: 'app-current-month-ne-promotion-ads',
    templateUrl: './current-month-ne-promotion-ads.component.html',
    encapsulation: ViewEncapsulation.None,
    styleUrls: ['../dashboard-css.css']
})

export class CurrentMonthNePromotionAdsComponent implements OnInit, AfterViewInit {
    ...
    ngAfterViewInit() {
        this._script.loadScripts('app-current-month-ne-promotion-ads',
        [
