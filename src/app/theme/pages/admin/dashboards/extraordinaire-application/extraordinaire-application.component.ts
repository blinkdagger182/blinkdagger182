...
import { PTVars } from './extraordinaire-application-vars';
...
@Component({
    selector: 'app-extraordinaire-application',
    templateUrl: './extraordinaire-application.component.html',
    encapsulation: ViewEncapsulation.None,
    styleUrls: ['../dashboard-css.css']
})

export class ExtraordinaireApplicationComponent implements OnInit, AfterViewInit {
    ...
    ngAfterViewInit() {
        this._script.loadScripts('app-extraordinaire-application',
        [
