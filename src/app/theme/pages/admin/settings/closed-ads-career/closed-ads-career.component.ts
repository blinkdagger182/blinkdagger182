...
import { CAVars } from './closed-ads-career-vars';
...
@Component({
    selector: 'app-closed-ads-career-component',
    templateUrl: './closed-ads-career.component.html',
    styleUrls: ['../settings-css.css']
})
export class StgClosedAdsCareerComponent implements OnInit {
    title1 = Vars.title1;
    ...
    ngAfterViewInit() {
        this._script.loadScripts('app-closed-ads-career-component',
            [
