...
import { EVLetterComponent } from './evl-tracking.component';
...
@NgModule({
    imports: [
        ...
        EVLetterComponent, FilterPipe,// SortByPipe
    ], bootstrap: [EVLetterComponent],
    providers: [DatePipe, GET_Service, POST_Service, PagerService, AlertService]
})
export class EVLetterModule {
}