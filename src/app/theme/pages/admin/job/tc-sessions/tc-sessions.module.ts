...
import { TcSessionsComponent } from './tc-sessions.component';
...
@NgModule({
  imports: [
    ...
    RouterModule,
], declarations: [TcSessionsComponent], bootstrap: [TcSessionsComponent],
    providers: [DatePipe, GET_Service, POST_Service, PagerService, AlertService,
      {provide: MAT_DATE_LOCALE, useValue: 'en-GB'}
    ],
})
export class TcSessionsModule { }
