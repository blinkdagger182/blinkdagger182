...
import { PTVars } from './project-tracking-vars';
...
export class ProjectTrackingComponent implements OnInit, AfterViewInit {
    ...
    ngAfterViewInit() {
        this._script.loadScripts('app-project-tracking',
        [
