...
export class JobAdvertisementTrackingComponent implements OnInit, AfterViewInit {
    ...
    onChangeTab() {
        ...
        }else if (this.typeView[0] == 'closed'|| this.typeView[0] == '18') {
            this.styleTypeViewAll = 'btn-warning';
            this.styleTypeViewAct = 'btn-outline-warning'; this.styleTypeViewCom = 'btn-outline-warning';
            this.styleTypeViewEva = 'btn-outline-warning'; this.styleTypeViewIv = 'btn-outline-warning';
            this.styleTypeViewCom = 'btn-outline-warning'; this.styleTypeViewRev = 'btn-outline-warning';
    ...
    errorDate = false;bccShowMsg = false;
    advPosMsg: string; advPosStyle: string; advPosIcon: string;
    submitFilter(type) {
        this.descEmptyData = 'List is Empty';
        this.bccShowMsg = false;
        this.loading = true;
        let filter = '';
        ...
        if ((myEd.setHours(0, 0, 0, 0) - mySt.setHours(0, 0, 0, 0)) / ONE_DAY < 0) {
            ...
            let dataPos = {};
            if (type === 0) {
                if (filter === '4_0_0_0_0' || filter === '5_0_0_0_0' || filter === '15_0_0_0_0' || filter === '1_0_0_0_0' || filter === '18_0_0_0_0'){
                ...
                // if(filter === '0_0_0_0_0')
                //     this.routers.navigate(['admin/job/advertisement-tracking/all_0_0_0_0']);
                // else{
                //     this.filterUrl = condStatus + '_' + condLob + '_' + condType + '_' + condFrom + '_' + condTo;
                //     this.routers.navigate(['admin/job/advertisement-tracking/' + this.filterUrl]);  
                // }
                ...
                this._POST_api_Service.POST_data(this.applyReportFilter, dataPos).subscribe(data => {
                    ...
                    if(error == 'Error: 500'){
                        ...
                        this.advPosMsg = 'Fail to submit form. Please try again later.';
                        // setTimeout(function() {
                            // this.bccShowMsg = false;
                ...
                this.setPage(1);
                this.loading = false;
                // this.routers.navigate(['admin/job/advertisement-tracking/0_0_0_0_0']);
            }
        }
