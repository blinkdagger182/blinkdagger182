export const NominationVars = Object.freeze({
    ...
    APIgetSubordinates: '/sp/admin/getsubordinates',
    APIgetPostProfile: '/sp/admin/getpositioninfo', //changed 22 JUL 2020
    //APIgetNewSuccessorProfile: '/sp/get_newsuccessorprofile', //added 26 JUL 2020
    APIPostInfo: '/sp/admin/basicInfo', // changed on 22 AUG 2020
    ...
    APIPostNominationStatus: '/sp/admin/updnominationstatus',
    getSPCurrBatch: '/sp/admin/currBatch',
    getSPBatchById: '/sp/admin/getSessionById/',
    ...
    spNomineeAdd: '/sp/admin/add_successorsByBatchId',
