...
import { IVSVars } from './iv-session-vars';
...
@Component({
    selector: 'app-iv-session',
    templateUrl: './iv-session.component.html',
    encapsulation: ViewEncapsulation.None,
    styleUrls: ['./iv-session.component.css'],
    providers: [
...
export class IvSessionComponent implements OnInit, AfterViewInit {
    ...
    tokenExists = false;
    currentUser;
    loading = false; errLoadData = IVSVars.errLoadData;
    ads = GlobalVariable.ADS; adsId = GlobalVariable.ADS_ID; posName = GlobalVariable.POS_NAME; posId = GlobalVariable.POS_ID;
    title1 = IVSVars.title1; pageSize = IVSVars.pageSize; APIGetImg = IVSVars.APIGetImg;
    ...
    urlImg = {
        front: GlobalVariable.BASE_API_URL + IVSVars.APIGetImg,
    ...
    checkLevel() {
        ...
        if ((!/1/i.test(usrRole)) && (!/5/i.test(usrRole))) {
	...
	getImgOptCurrent() {
     ...
     interviewDetails(){
         let sessionPost = {
          ...
          this._POST_api_Service.POST_IDP_data(IVSVars.postApplicantDetails, sessionPost).subscribe(dataRes => {
          ...
          //postDownloadReport
          this.reportArr = [];
          this._POST_api_Service.POST_IDP_data(IVSVars.postDownloadReport, sessionPost).subscribe(dataRes => {
    ...
    submitFilter(type){
        ...
        if(type === 0){
          ...
          this._POST_api_Service.POST_IDP_data(IVSVars.postSearchFilter, dataPos).subscribe(dataRes => {
      ...
      getReportFilter() {
              this.filters= {};
              this._GET_api_Service.GET_IDP_data(IVSVars.postFilterLobAdv).subscribe(data => {
              this.filters = data;
              this.loading = false;  
      ...
      mylob = '';
      getlob() {
           this._GET_api_Service.GET_REC_DATA(IVSVars.getLOBAPI).subscribe(data => {
   ...
   //search panel
    ...
    getPanelDetail(e) {
      ...
      this._POST_api_Service.POST_IDP_data(IVSVars.postSearchPanel, data).subscribe(dataRes => {
  ...
  //Add panel
   addPnLoading = false;
    addPanel(){ 
      ...
      let addUserSend = this._POST_api_Service.POST_IDP_data(IVSVars.postAddPanel, dataAddPanel);
      let dataAdd: any = {};
    ...
    getlistInterview() {
        ...
        this.loading = true; 
        this.getListLoading = false;
        this._GET_api_Service.GET_IDP_data(IVSVars.getListApplicant).subscribe(data => {
    ...
    //Delete Panel
      ...
      delPanel(){
        ...
        this.loading = true; 
        let delUserSend = this._POST_api_Service.POST_IDP_data(IVSVars.postDeletePanel, data);
        let dataDel: any = {};
    ...
    //Edit Panel
     ...
     editPanel(){ 
        ...
        let editPnSend = this._POST_api_Service.POST_IDP_data(IVSVars.postEditPanel, dataEditPnPost);
        let dataEditPn: any = {};
    ...
    editCandidate(){
     ...
     let candIntDt = ((document.getElementById("editCnDate") as HTMLInputElement).value); 
      ...
      this.loading = true; 
      this._POST_api_Service.POST_IDP_data(IVSVars.postEditCandidate, dataPostCandidate).subscribe(dataRes => {
    ...
    //To set Candidate Absent (old)
     ...
     candidateAbsent(candId){
       ...
       this.loading = true; 
       let absCandSend = this._POST_api_Service.POST_IDP_data(IVSVars.postAbsentCandidate, dataCandidate);
       let dataAbsCand: any = {};
   ...
   candidateAttend(candIdAtt){
     ...
     this.loading = true; 
     let attCandSend = this._POST_api_Service.POST_IDP_data(IVSVars.postActiveCandidate, dataCand);
     let dataAttCand: any = {};
    ...
    addSession(){
        ...
        this.loading = true; 
        let addUserSend = this._POST_api_Service.POST_IDP_data(IVSVars.postAddSession, dataAddPost);
        let dataAdd: any = {};
        let ret = addUserSend.subscribe(dataRes => {
            dataAdd = dataRes;
            if (dataAdd.status === 0) {
    ...
    editSession(){
        ...
        dataEditPost = {
            ...
            this.loading = true; 
            let EditSesSend = this._POST_api_Service.POST_IDP_data(IVSVars.postEditSession, dataEditPost);
            let dataEdit: any = {};
    ...
    saveDraft() {
        ...
        this._POST_api_Service.POST_IDP_data(IVSVars.postSaveDraft, posData).subscribe(dataRes => {
   ...
   submitToHR(){
     ...
     let submitSend = this._POST_api_Service.POST_IDP_data(IVSVars.postSubmit, dataSubmit);
