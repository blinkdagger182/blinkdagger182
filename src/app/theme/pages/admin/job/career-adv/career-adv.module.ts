...
import { CareerAdvComponent } from './career-adv.component';
...
@NgModule({
    imports: [
        ...
        CareerAdvComponent, FilterPipe,// SortByPipe
    ], bootstrap: [CareerAdvComponent],
    providers: [DatePipe, GET_Service, POST_Service, PagerService, AlertService]
})
export class CareerAdvModule {
}